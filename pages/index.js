    ...
    <div style={{height: "100%"}}>
      ...
      <main style={{height: "100%"}}>
        <a href="/detail" style={{display: "flex", width: "100%", height: "50%"}}>
          <div style={{backgroundColor: "red", width: "100%", height: "100%"}}><button onClick={() => window.open('', '_self').close()}>閉じる window.open('', '_self').close()</button></div>
          <div style={{backgroundColor: "blue", width: "100%"}}><button onClick={() => liff.closeWindow()}>閉じる liff.closeWindow()</button></div>
